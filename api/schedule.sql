...
CREATE TABLE `operators` (
  ...
  `operator_send_email` tinyint(1) NOT NULL,
  `operator_send_sms` tinyint(1) NOT NULL,
  `operator_active` tinyint(1) NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin','X03MO1qnZdYdgyfeuILPmQ','System','Admin','2021-05-20 01:00:00',1);
UNLOCK TABLES;
...
CREATE TABLE `meetings` (
  ...
  CONSTRAINT `meetings_ibfk_1` FOREIGN KEY (`senate_committee`) REFERENCES `committees` (`committee_id`) ON DELETE SET NULL,
  CONSTRAINT `meetings_ibfk_2` FOREIGN KEY (`house_committee`) REFERENCES `committees` (`committee_id`) ON DELETE SET NULL,
